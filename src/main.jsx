...
const emptyInvoice = { invoiceNo: '', invoiceDate: '', roomNo: '', guest: '', checkIn: '', checkOut: '', nights: 1, roomRate: '', accommodation: '', restaurant: '', laundry: '', total: '', amountWords: '' };
...
function App(){
  ...
  async function readImage(){if(!file)return;setReading(true);setProgress(3);try{
    ...
    const parsed=parseInvoiceOcr(texts,description);
    ...
    setNotice(parsed.verified?'✓ تمت مطابقة مجموع البنود مع إجمالي الفاتورة. الشيت جاهز.':'⚠ لم تتطابق الأرقام تلقائيًا. راجع البنود حتى يساوي مجموعها إجمالي الفاتورة.');
